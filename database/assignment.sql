...
CREATE TABLE IF NOT EXISTS public.dreamVehicle (

dream_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
dream_make character varying NOT NULL,
dream_model character varying NOT NULL,
dream_year character(4) NOT NULL,
dream_description text NOT NULL,
dream_image character varying NOT NULL,
dream_thumbnail character varying NOT NULL,
dream_price numeric(9, 0) NOT NULL,
dream_miles integer NOT NULL,
dream_color character varying NOT NULL
)
